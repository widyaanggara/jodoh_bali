    ...
    <footer className="bg-stone-50 pt-20 pb-10 border-t border-accent-gold/10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h6 className="font-bold text-stone-900 mb-6">Perusahaan</h6>
          ...
          <div>
            <h6 className="font-bold text-stone-900 mb-6">Dukungan</h6>
            <ul className="space-y-4 text-sm text-stone-500">
          ...
          <div>
            <h6 className="font-bold text-stone-900 mb-6">Legal</h6>
            <ul className="space-y-4 text-sm text-stone-500">
