...
export default function MencariJodoh() {
    ...
    const [searchYear, setSearchYear] = useState('2000'); // Default tahun kelahiran jodoh
    ...
    // Tahun kelahiran jodoh potensial (30 tahun ke belakang dari sekarang)
    const startYear = currentYear - 30; // 1996
    const years = Array.from({ length: 31 }, (_, i) => startYear + i); // 1996-2026
                        ...
                        <div className="max-w-2xl mx-auto slide-up delay-200">
                            <div className="bg-surface-light dark:bg-surface-dark p-8 md:p-10 rounded-[2.5rem] shadow-2xl shadow-stone-200 dark:shadow-none border border-accent-gold/10">
                                <div className="grid md:grid-cols-2 gap-8 mb-8">
                                    ...
                                    <div className="space-y-3 text-left group">
                                        <label htmlFor="searchYear" className="text-[10px] uppercase tracking-[0.2em] font-bold text-stone-400 dark:text-stone-500 ml-1">Tahun Kelahiran Jodoh</label>
                                        <div className="relative">
                ...
                {userProfile && (
                    <section className="pb-24 px-6 relative z-10 fade-in">
                        <div className="max-w-5xl mx-auto space-y-12">
                            {/* User Profile Card */}
                            <div className="max-w-xl mx-auto bg-surface-light dark:bg-surface-dark p-8 rounded-[2rem] border border-accent-gold/10 shadow-xl">
