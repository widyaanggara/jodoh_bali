                ...
                {result && (
                    <section className="pb-24 px-6 relative z-10 fade-in">
                        <div className="max-w-4xl mx-auto space-y-12">
                            ...
                            <div className="bg-surface-light dark:bg-surface-dark p-8 md:p-10 rounded-[2.5rem] border border-accent-gold/10 shadow-xl shadow-stone-200/50 dark:shadow-none slide-up delay-200">
