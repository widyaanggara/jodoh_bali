                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                                ...
                                <div className="bg-surface-light p-8 md:p-10 rounded-[2.5rem] border border-accent-gold/10 shadow-xl shadow-stone-200/50 slide-up delay-200">
                                    ...
                                    <div className="text-center">
                                        <div className="inline-block px-8 py-4 bg-accent-gold/10 rounded-2xl mb-6">
                                            ...
                                            <span className="text-sm font-medium ml-2 opacity-60">
                                                ({result.kategori.score || 0}%)
                                            </span>
                                        </div>

                                        <div className="bg-white/80 backdrop-blur rounded-2xl p-6 text-left border border-stone-200/50 shadow-sm">
                                            <h4 className="text-xs uppercase tracking-widest font-bold text-stone-500 mb-2">📖 Makna & Penjelasan</h4>
                                            <p className="text-stone-800 leading-relaxed text-sm">{result.kategori.deskripsi || result.kategori.makna}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {result.mod16Result && (
                                    <div className="bg-linear-to-br from-purple-50 to-indigo-50 p-8 md:p-10 rounded-[2.5rem] border border-purple-200/50 shadow-xl shadow-purple-100 slide-up delay-300">
                                        <div className="text-center mb-8">
                                        ...
                                        <div className="bg-white/80 backdrop-blur rounded-2xl p-6">
                                            <div className="text-center mb-4">
                                                <div className="inline-block px-6 py-3 bg-purple-500 text-white rounded-xl mb-3">
                                                    ...
                                                    <p className="text-3xl font-bold">
                                                        {result.mod16Result.label}
                                                    </p>
                                                    <span className="text-lg font-medium ml-3 opacity-70">
                                                        ({result.mod16Result.score}%)
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="bg-indigo-50/50 rounded-xl p-4">
                                                    ...
                                                    <p className="text-indigo-900 leading-relaxed text-sm">{result.mod16Result.deskripsi}</p>
                                                </div>
                                            </div>
