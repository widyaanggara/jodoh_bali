...
type FeatureType = 'kecocokan_pasangan' | 'mencari_jodoh' | 'ramalan_pernikahan' | 'ramalan_otonan' | 'samyoga';
...
const featureColors: Record<FeatureType, string> = {
    ...
    samyoga: 'bg-blue-100 text-blue-700 border-blue-200'
};
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <>
                        ...
                        <div className="grid md:grid-cols-6 gap-6 mb-12">
                            ...
                            {/* Samyoga */}
                            <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-3xl p-6 shadow-xl shadow-blue-500/20 text-white relative overflow-hidden group hover:scale-105 transition-transform">
                                <div className="absolute top-0 right-0 opacity-10 group-hover:opacity-20 transition-opacity">
                                    <span className="material-symbols-outlined text-7xl">handshake</span>
                                </div>
                                <div className="relative z-10">
                                    <div className="flex items-center gap-2 mb-3">
                                        <span className="material-symbols-outlined text-white/70 text-lg">handshake</span>
                                        <p className="text-[10px] uppercase tracking-widest font-bold text-white/70">Samyoga</p>
                                    </div>
                                    <p className="text-4xl font-bold">{byFeature.samyoga}</p>
                                    <p className="text-sm text-white/60 mt-1">analisis</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl shadow-xl border border-stone-100 overflow-hidden">
                            <div className="p-6 border-b border-stone-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {(['all', 'kecocokan_pasangan', 'mencari_jodoh', 'ramalan_pernikahan', 'ramalan_otonan', 'samyoga'] as FilterType[]).map((filter) => (
                                        <button
                                            key={filter}
                                            onClick={() => setActiveFilter(filter)}
                                            className={`px-4 py-1.5 rounded-full text-xs font-bold transition-all duration-300 ${activeFilter === filter
                                    ...
                                    <div className="flex items-center gap-1">
                                        {getPageNumbers().map((page, idx) => (
                                            <button
                                                ...
                                                disabled={page === '...'}
                                                className={`min-w-[40px] h-10 flex items-center justify-center rounded-xl font-bold text-sm transition-all ${currentPage === page
